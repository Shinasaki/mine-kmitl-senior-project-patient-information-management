...
<?php	include("./include/user_head_right.php"); ?>
	...
	<form name="CN3FormLHS" action="./cn1-smelling_proc.php" method="POST">
	<input type="hidden" name="location" value="" />

<?php
	$sql="
	SELECT `R_eom_LHS`, `L_eom_LHS`
	...
	while($rs = mysql_fetch_array($result)){
		$R_oem_LHS = $rs["R_eom_LHS"];
		$L_oem_LHS = $rs["L_eom_LHS"];
	}
	if($num == 1){	//send function
?>		<input type="hidden" name="fn" value="CN3_edit_LHS"><?php
	}else{
?>		<input type="hidden" name="fn" value="CN3_addNew_LHS"><?php
	}
?>
	<div data-role="content" class="container_12">
		...
		<div data-role="navbar" data-iconpos="top" class="grid_12 space-height">
			<ul>
				<li>
					<a href="cn3_4_6-EOM.php" data-theme="" data-icon="arrow-l" rel="external" >
						Right EOM
					</a>
				</li>
				<li>
					<a href="cn3_4_6-EOM_LHS.php" data-theme="" data-icon="arrow-r" rel="external" class="ui-btn-active" data-transition="none">
						Left EOM
					</a>
				</li>
			</ul>
...
?>					<div id="imageEyeR" style="background-image: url(./images/eye-bg.png); width: 235px; height: 162px; ">
						<img src="images/cn3-4-6-pupil-right.png" <?php echo "style=\"position:relative; top: 50px; right: ".(-85+(-1*$R_oem_LHS))."px;\" ";?> alt="pupil">
					</div>
<?php	//		</a>
?>			</div>
...
?>					<div id="imageEyeL" style="background-image: url(./images/eye-bg.png); width: 235px; height: 162px; ">
						<img src="images/cn3-4-6-pupil-left.png" <?php echo "style=\"position:relative; top: 50px; right: ".(-85+(-1*$L_oem_LHS))."px;\" ";?> alt="pupil">
					</div>
<?php	//		</a>
?>			</div><!--end  wrapper-eye-left-->
			...
			<div class="grid_12 space-height">
				<div  id="eom-eye-value-right">
					<div data-role="fieldcontain" >
						<input type="range" name="oem" id="oem" onChange="CN3_eye(); " value="<?=$R_oem_LHS?>" min="-50" max="50"  data-theme="a" data-track-theme="b" />
					</div>
				</div>
			</div>
			<div class="grid_6">
		...
		<span id="CN3_part2">
			<div class="grid_6">
				...
				<div  id="eom-eye-value-right">
					<div data-role="fieldcontain" >
						<input type="range" name="R_oem_LHS" id="R_oem" onChange="CN3_eyeR(); " value="<?=$R_oem_LHS?>" min="-50" max="50"  data-theme="a" data-track-theme="b" />
			...
			<div class="grid_6">
				<div  id="eom-eye-value-left">
					<div data-role="fieldcontain" >
						<input type="range" name="L_oem_LHS" id="L_oem" onChange="CN3_eyeL(); " value="<?=$L_oem_LHS?>" min="-50" max="50"  data-theme="a" data-track-theme="b" />
					</div>
				</div>
			</div>	<!-- end grid 6-->
		</span>			
		<div class="grid_12 space-height">
			<a href="#" data-role="button" onclick="CN3_submit('LHS') ;" class="ui-btn-active" rel="external">Update</a>
		</div>
	</div> <?php //end content ?>
	</form>
</div>
