	...
	<div data-role="fieldcontain" class="slider-bar">
					...
					<div class="grid_12">
						<div data-role="fieldcontain" >
							<!--<label for="slider-1">Size: </label> -->
							<input type="range" name="tempreture" id="tempreture" value="<?=$tempreture?>" min="32" max="40"  data-theme="a" data-track-theme="b" />
						</div><!--end slide Temperature -->
					</div>

					<div class="grid_12 margin-btm"><h1  id="title-right-box-full-2">Blood Pressure</h1></div><!--end --> 
					<div class="grid_12">
						<div data-role="fieldcontain" >
							<!--<label for="slider-1">Size: </label> -->
							<input type="range" name="p_bp" id="p_bp" value="<?=$p_bp?>" min="20" max="240"  data-theme="a" data-track-theme="b" />
						</div><!--end slide P.BP -->
					</div>
					...
					<div class="grid_12">
						<div data-role="fieldcontain" >
							<!--<label for="slider-1">Size: </label> -->
							<input type="range" name="r" id="r" value="<?=$r?>" min="10" max="100"  data-theme="a" data-track-theme="b" />
						</div><!--end slide R-->                               
					</div>
				</div><!--end content -->
			</div><!--end page -->
